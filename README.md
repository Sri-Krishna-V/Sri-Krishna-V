...
| Project | Description |
|---|---|
| [![awesome-adk-agents](https://img.shields.io/badge/awesome--adk--agents-F25623?style=flat-square&logoColor=white)](https://github.com/Sri-Krishna-V/awesome-adk-agents) | Curated ADK agent templates, best practices & production-ready examples — 262 stars |
| [![Derived-WMD](https://img.shields.io/badge/Derived--WMD-F25623?style=flat-square&logoColor=white)](https://github.com/Sri-Krishna-V/Derived-WMD) | Agentic Generative UI: NL → production-ready React apps via Tambo agents + MCP |
...
| [![Schneider_Hack](https://img.shields.io/badge/Schneider__Hack-F25623?style=flat-square&logoColor=white)](https://github.com/Sri-Krishna-V/Schneider_Hack) | AI platform generating regulation-aware test cases from requirement docs (RAG + KG + FastAPI) |
| [![Nikoness](https://img.shields.io/badge/Nikoness-F25623?style=flat-square&logoColor=white)](https://github.com/Sri-Krishna-V/Nikoness) | Intelligent doc search & retrieval with Haystack AI, Gemini 2.5 & Qdrant |
| [![Rora](https://img.shields.io/badge/Rora-F25623?style=flat-square&logoColor=white)](https://github.com/Sri-Krishna-V/Rora) | Agentic Unit Tester — TypeScript |
| [![gemma3n-critical-thinking-finetune](https://img.shields.io/badge/gemma3n--critical--thinking--finetune-F25623?style=flat-square&logoColor=white)](https://github.com/Sri-Krishna-V/gemma3n-critical-thinking-finetune) | Gemma3n fine-tuned on Openthoughts3 1.2M for critical thinking |

**Full-Stack · Apps · Tools**

| Project | Description |
|---|---|
| [![GuruSetu](https://img.shields.io/badge/GuruSetu-F25623?style=flat-square&logoColor=white)](https://github.com/Sri-Krishna-V/GuruSetu) | Academic research collaboration — FastAPI, Neo4j, Next.js, sentence transformers |
| [![Elu](https://img.shields.io/badge/Elu-F25623?style=flat-square&logoColor=white)](https://github.com/Sri-Krishna-V/Elu) | Chrome extension for web accessibility — on-device LLM via WebGPU, zero cloud |
| [![Saga3D](https://img.shields.io/badge/Saga3D-F25623?style=flat-square&logoColor=white)](https://github.com/Sri-Krishna-V/Saga3D) | Stunning 3D isometric system design / architecture diagrams |
...
| [![rslms](https://img.shields.io/badge/rslms-F25623?style=flat-square&logoColor=white)](https://github.com/Sri-Krishna-V/rslms) | Library management system — CLI + REST API + FastAPI + PostgreSQL |
